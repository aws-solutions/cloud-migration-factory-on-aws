      ...
      <div>
        ...
        {props.dataWaves.isLoading
          ...
          <Link fontSize="display-l" href="#" data-testid={'completed-waves'}>
              <span
                className="custom-link-font-weight-light">{props.completed.waveIds.length}</span>
          </Link>
        }
      </div>
      <div>
        ...
        {props.dataApps.isLoading
          ...
          <Link fontSize="display-l" href="#">
              <span
                className="custom-link-font-weight-light">{props.completed.applicationIds.length}</span>
          </Link>
        }
      </div>
      <div>
        ...
        {props.dataServers.isLoading
          ...
          <Link fontSize="display-l" href="#">
              <span
                className="custom-link-font-weight-light">{props.completed.serverIds.length}</span>
          </Link>
        }
      </div>
      <div>
        ...
        {props.dataDatabases.isLoading
          ...
          <Link fontSize="display-l" href="#">
              <span
                className="custom-link-font-weight-light">{props.completed.databaseIds.length}</span>
          </Link>
        }
      </div>
    </ColumnLayout>
