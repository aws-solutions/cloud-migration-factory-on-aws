...
const ChartServerEnvTypes = ({ data }) => {
  ...
  return (
    <Container
      header={
        <Header variant="h2" description="Stage or environment summary for all servers in migration factory datastore.">
          Server Environments
        </Header>
      }
    >
