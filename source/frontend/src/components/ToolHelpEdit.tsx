  ...
  if (editingSchemaInfoHelpTemp) {
    return (
      <SpaceBetween direction={"vertical"} size={"xxl"}>
        <FormField key={"help_header"} label={"Help title"} description={"Enter the content title."}>
          <Input
        ...
        <FormField
          ...
          label={"Help content"}
          description={
            "Enter the content for the main help section, Use p, a, h3, h4, h5, span, div, ul, ol, li, code, pre, dl, dt, dd, hr, br, i, em, b, strong html tags to format the content."
          }
        >
          <Textarea
        ...
        <FormField key={"help_links"} label={"Help links"} description={"Add any links to relevant content."}>
          <TagEditor
            ...
            i18nStrings={{
              ...
              removeButton: "Remove",
              undoButton: "Undo",
              undoPrompt: "This URL will be removed upon saving changes",
              ...
              emptyTags: "No URLs defined.",
              tooManyKeysSuggestion: "You have more labels than can be displayed",
              tooManyValuesSuggestion: "You have more URLs than can be displayed",
              keysSuggestionLoading: "Loading URL labels",
              keysSuggestionError: "URL labels could not be retrieved",
              valuesSuggestionLoading: "Loading URLs",
              valuesSuggestionError: "URLs could not be retrieved",
              emptyKeyError: "You must specify a URL label",
              maxKeyCharLengthError: "The maximum number of characters you can use in a URL label is 128.",
              maxValueCharLengthError: "The maximum number of characters you can use in a URL is 256.",
              duplicateKeyError: "You must specify a unique URL label.",
              invalidKeyError:
              ...
              tagLimit: (availableTags) =>
                availableTags === 1
                  ...
                  : "You can add up to " + availableTags + " more URLs.",
              tagLimitReached: (tagLimit) =>
                tagLimit === 1
                  ? "You have reached the limit of 1 URL."
                  : "You have reached the limit of " + tagLimit + " URLs.",
              tagLimitExceeded: (tagLimit) =>
                tagLimit === 1
                  ? "You have exceeded the limit of 1 URL."
                  : "You have exceeded the limit of " + tagLimit + " URLs.",
