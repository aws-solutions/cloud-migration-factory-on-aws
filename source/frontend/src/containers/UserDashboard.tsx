...
type CompletedItems = {
  waves: Array<any> | undefined,
  applications: Array<any> | undefined,
  servers: Array<any> | undefined,
  databases: Array<any> | undefined
}

type UserDashboardProps = {
  setHelpPanelContent: (content: any, silent?: boolean) => Promise<void>
}
...
const UserDashboard = (props: UserDashboardProps) => {
   ...
   */
  function getMigratedItems(): CompletedItems {
