    ...
    <MemoryRouter initialEntries={["/login"]}>
      <SessionContext.Provider value={NO_SESSION}>
        ...
        <Routes>
          ...
          <Route path={"/change/pwd"} element={<>This is the change password page</>}>
            {" "}
          </Route>
          <Route path={"/forgot/pwd"} element={<>This is the forgot password page</>}>
            {" "}
          </Route>
          <Route path={"/"} element={<>This is the authenticated landing page</>}>
            {" "}
          </Route>
        </Routes>
