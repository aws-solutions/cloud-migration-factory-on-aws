...
const ChangePassword = () => {
  ...
  return (
    <Box margin="xxl" padding="xxl">
      <Form
        header={<Header variant="h1">Change Password</Header>}
        actions={
        ...
        <Container>
          <SpaceBetween size={"xl"} direction={"vertical"}>
            <SpaceBetween size={"xxs"} direction={"vertical"}>
              ...
              <FormField key={"oldPassword"} label={"Current password"}>
                <Input value={oldPassword} onChange={(event) => setOldPassword(event.detail.value)} type="password" />
              </FormField>
              ...
              >
                <Input value={newPassword} onChange={(event) => setNewPassword(event.detail.value)} type="password" />
              </FormField>
