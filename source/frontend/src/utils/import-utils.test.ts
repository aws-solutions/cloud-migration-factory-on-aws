      ...
      "data": [
        {
          ...
          "__validation": {
            ...
            "informational": [
              {
                "attribute": "app_name",
                "error": "Ambiguous attribute name provided. It is found in multiple schemas [database, application, server]. Import will map data to schemas as required based on record types."
              },
              {
                "attribute": "wave_name",
                "error": "Ambiguous attribute name provided. It is found in multiple schemas [wave, application]. Import will map data to schemas as required based on record types."
              }
            ]
          }
        }
