...
export const defaultSchemas: Record<string, EntitySchema> = {
  ...
  server: {
    ...
    attributes: [
      ...
      },
      {
        ...
        validation_regex_msg: "Server FQDN must contain only alphanumeric, hyphen or period characters.",
        group_order: "-999",
        type: "string",
        required: true,
      },
    ...
    attributes: [
      {
        system: true,
        validation_regex: "^(?!\\s*$).+",
        listvalue: "us-east-1,us-west-2,ap-southeast-2,ap-northeast-1,eu-central-1,eu-west-1,eu-west-2",
        name: "home_region",
        description: "Home Region",
        validation_regex_msg: "You must select a MGH home region.",
        group_order: "1",
        type: "list",
        required: true,
      },
  ...
  task_execution: {
    ...
    attributes: [
      ...
      {
        system: true,
        rel_display_attribute: "task_name",
        rel_key: "task_id",
        name: "task_id",
      ...
      {
        system: true,
        rel_display_attribute: "task_type",
        rel_key: "task_id",
        name: "task_type",
        ...
        type: "relationship",
        required: true,
        long_desc: "Pipeline Task Type",
      },
      {
        system: true,
        rel_display_attribute: "task_description",
        rel_key: "task_id",
        ...
        type: "relationship",
        required: true,
        long_desc: "Pipeline Task Description",
      },
      {
  ...
  pipeline_template_task: {
    ...
    attributes: [
      {
        name: "pipeline_template_task_id",
        description: "Pipeline Template Task Id",
        system: true,
        hidden: true,
        type: "string",
        required: true,
  ...
  task: {
    ...
    attributes: [
      ...
      },
      {
        ...
        name: "task_name",
        description: "Name",
        validation_regex_msg: "Provide a name for this task.",
        type: "string",
        required: true,
        long_desc: "Task name",
      },
      {
        ...
        validation_regex_msg: "Provide a description of the outcome for this task.",
        type: "string",
        required: true,
        long_desc: "Task description.",
      },
      {
        name: "task_type",
        description: "Task Type",
      ...
      {
        name: "lambda_function_name_suffix",
        description: "Lambda Function Name Suffix",
        system: true,
        type: "string",
        hidden: true,
        long_desc:
          "Lambda Function name suffix that should be specified if task_type is Automated. Final Lambda function call will be formatted {application}-{environment}-{lambda_function_name_suffix}.",
      },
      {
        name: "ssm_script_name",
        description: "SSM Script Name",
        system: true,
        type: "string",
        hidden: true,
        long_desc: "Name of script if task triggers an SSM command",
      },
      {
        name: "ssm_script_version",
        description: "SSM Script Version",
        system: true,
        type: "string",
        hidden: true,
        long_desc: "Name of script version if task triggers an SSM command",
      },
      {
        name: "task_arguments",
        description: "Task Arguments",
        ...
        type: "json",
        hidden: true,
        long_desc: "Required arguments in order to execute a task.",
      },
    ],
    schema_name: "task",
  },
